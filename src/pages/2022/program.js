...
const IndexPage = ({data}) => {
  ...
  return(
    <Layout>
      <SEO title="Emberfest Line Up 2022" noindex />
      ...
      <h1 className="text-2xl uppercase mt-8 lg:mt-16 mb-4 md:text-5xl">LINE UP 2022</h1>
...
query ProgramQuery2022 {
    allMarkdownRemark(filter: {fileAbsolutePath: {glob: "**/pages/2022/program/**/*"}}, sort: {fields: frontmatter___showstart}) {
      edges {
        node {
          frontmatter {
            description
